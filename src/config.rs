...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("46.39.6.70:21116".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("SRustDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["46.39.6.70"];
pub const RS_PUB_KEY: &str = "1r6NcjlMD4Xp6nY+MVNlc7pjUoGbRhft2YKuGq5wb2U=";
